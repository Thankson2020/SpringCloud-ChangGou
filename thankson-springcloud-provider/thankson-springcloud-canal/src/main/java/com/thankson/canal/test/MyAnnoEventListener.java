...
import com.thankson.common.component.canal.annotation.content.DeleteListenPoint;
import com.thankson.common.component.canal.annotation.content.InsertListenPoint;
import com.thankson.common.component.canal.annotation.content.UpdateListenPoint;
import com.thankson.common.component.canal.annotation.table.AlertTableListenPoint;
import com.thankson.common.component.canal.annotation.table.CreateIndexListenPoint;
import com.thankson.common.component.canal.annotation.table.CreateTableListenPoint;
import com.thankson.common.component.canal.annotation.table.DropTableListenPoint;
...
public class MyAnnoEventListener {
    ...
    @UpdateListenPoint
    public void onEventUpdateData01(CanalMsg canalMsg, CanalEntry.RowData rowData) {
        System.out.println("进入到第一种方式");
    }

    @UpdateListenPoint
    private void getColumnValue(CanalEntry.EventType eventType, CanalEntry.RowData rowData) {
        System.out.println("进入到第二种方式");
    }
